...
public class PermissionHandler {
    ...
    public static String[] APP_PERMISSION = {Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA};
//    public static String[] LOCATION_PERMISSION = {Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION};
    ...
    private void showPermissionExplanation(String sMSG, final int nPermissionFlag) {
        ...
        alertPermission.setMessage("To assist you better, " + aActivity.getResources().getString(R.string.app_name) +" app requires" + sMSG+"permission. Would you like to grant these permissions?")
